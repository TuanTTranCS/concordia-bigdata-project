...
*Note: Details on statistical inferences section can be seen in the [Statistical Inferences Notebook](BigData_Project_Statistical_Inferences.ipynb)*
...
*Prediction model training code: [Prediction Model](ML_model.ipynb)*
